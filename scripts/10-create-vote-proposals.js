...
(async () => {
      ...
      [
        {
          ...
          // In this case we are sending 0 ETH. We're just minting new tokens to the treasury.
          // So, set to 0
          nativeTokenValue: 0,
          ...
          // Our token address that actually executes the mint
  ...
  try {
    ...
    await voteModule.propose(
      "Should the DAO transfer " + amount + " tokens from the treasure to " + process.env.WALLET_ADDRESS +
      " for being awesome?",
      [
        {
          // Again we are sending ourselves 0 ETH. Just sending our own token.
          nativeTokenValue: 0,
